...
export function StatsSection({ scrollToSection }: { scrollToSection?: (index: number) => void }) {
      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "50K+", label: "Snacks Analyzed", sublabel: "Global database", direction: "right" },
              { value: "15+", label: "Languages", sublabel: "Ingredient support", direction: "left" },
              { value: "99%", label: "Accuracy", sublabel: "Data verification", direction: "right" },
            ].map((stat, i) => {
